...
import Base: (*)
    ...
    function dflovo(
        ...
        # Checks initial algorithm initialization conditions.
        m_min = n + 2
        ...
        @assert 0 < δ ≤ Δ "The radius of the sample set 'δ' must be positive and less or equal to the trust-region radius 'Δ'."
        ...
        @assert β > 0 "The parameter 'β' must be positive."
        @assert 0 < τ1 < 1 "The parameter 'τ1' must be positive and less than one."
        @assert 1 ≤ τ2 "The parameter 'τ2' must be greater than or equal to one."
        @assert τ2 ≤ τ3 "The parameter 'τ3' must be greater than or equal to 'τ2'."
        @assert 0 < η1 < 1 "The parameter 'η1' must be positive and less than one."
